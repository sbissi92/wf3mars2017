...
$(document).ready(function(){
    ...
    */
        // Sélectionner une/des balise/s pour son nom (tag)
    ...
    */
        ...
        var deathSeclector = $('h3').prev().parent().parent().next().parent().find('main').children('article').find('h3');
        console.log( 'Balise sélectionnée : ', deathSeclector )
